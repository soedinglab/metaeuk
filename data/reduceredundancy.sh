...
if notExists "${TMP_PATH}/$1_dp_contig_strand_map_sorted_by_bitscore"; then
    $MMSEQS filterdb "${TMP_PATH}/$1_dp_contig_strand_map" "${TMP_PATH}/$1_dp_contig_strand_map_sorted_by_bitscore" --sort-entries 2 --filter-column 5 \
...
if notExists "${TMP_PATH}/$1_dp_contig_strand_map_sorted_by_num_exons_subsorted_by_bit"; then
    $MMSEQS filterdb "${TMP_PATH}/$1_dp_contig_strand_map_sorted_by_bitscore" "${TMP_PATH}/$1_dp_contig_strand_map_sorted_by_num_exons_subsorted_by_bit" --sort-entries 2 --filter-column 6 \
...
if notExists "${TMP_PATH}/$1_dp_contig_strand_map_sorted_by_start_subsorted_by_num_and_bit"; then
    $MMSEQS filterdb "${TMP_PATH}/$1_dp_contig_strand_map_sorted_by_num_exons_subsorted_by_bit" "${TMP_PATH}/$1_dp_contig_strand_map_sorted_by_start_subsorted_by_num_and_bit" --sort-entries 1 --filter-column 7 \
...
if notExists "${TMP_PATH}/$1_grouped_predictions"; then
    $MMSEQS grouppredictions "${TMP_PATH}/$1_dp_contig_strand_map_sorted_by_start_subsorted_by_num_and_bit" "${TMP_PATH}/$1_grouped_predictions" \

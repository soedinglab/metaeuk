...
std::vector<struct Command> commands = {
        ...
        {"predictexons",             predictexons,            &par.predictexonsworkflow,    COMMAND_MAIN,
                ...
                "An analog of 6-frame translation to produce putative protein fragments. Search against protein DB. Compatible exon set identified with respect to each target. Two dynamic programming outputs: metaeukBaseName_dp_protein_contig_strand_map and metaeukBaseName_dp_optimal_exon_sets",
                "Eli Levy Karin <eli.levy.karin@gmail.com> ",
                "<i:contigsDB> <i:proteinsDB> <o:metaeukBaseName> <tmpDir>",
                CITATION_MMSEQS2},
        ...
        {"unitesetstosequencedb",             unitesetstosequencedb,            &par.onlythreads,    COMMAND_EXPERT,
                ...
                "Eli Levy Karin <eli.levy.karin@gmail.com> ",
                "<i:contigsDB> <i:proteinsDB> <i:dp_protein_contig_strand_map> <i:dp_optimal_exon_sets> <o:outDB>",
                CITATION_MMSEQS2},
        {"reduceredundancy",             reduceredundancy,            &par.reduceredundancyworkflow,    COMMAND_MAIN,
                ...
                "A protein coding gene can be predicted more than once due to target DB homologies. A cluster representative is selected. Predictions in a cluster share an exon with the representative. Output: metaeukBaseName_grouped_predictions",
                "Eli Levy Karin <eli.levy.karin@gmail.com> ",
                "<i:metaeukBaseName> <tmpDir>",
                CITATION_MMSEQS2},
        {"assigntaxonomy",             assigntaxonomy,            &par.assigntaxonomyworkflow,    COMMAND_MAIN,
                ...
                CITATION_MMSEQS2},
        {"unitetoseqdb",             unitetoseqdb,            &par.unitetoseqdbworkflow,    COMMAND_MAIN,
                "Unite the exons of predictions to sequence BD",
                "Unite the exons of predictions (either before or after redundancy reduction) to sequence BD",
                "Eli Levy Karin <eli.levy.karin@gmail.com> ",
                "<i:contigsDB> <i:proteinsDB> <i:metaeukBaseName> <tmpDir>",
                CITATION_MMSEQS2},
